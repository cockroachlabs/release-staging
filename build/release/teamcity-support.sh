...
push_to_git() {
  # The value for GIT_SSH needs to be a file. It can't be a bash function.
  GIT_SSH="$(pwd)/build/release/teamcity-git-ssh-wrapper.sh" git push $1 $2
}
