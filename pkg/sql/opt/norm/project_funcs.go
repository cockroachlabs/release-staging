...
// UseImprovedJoinElimination allows the column-remapping join elimination rules
// to be enabled (and disabled).
func (c *CustomFuncs) UseImprovedJoinElimination() bool {
	return c.mem.EvalContext().SessionData().OptimizerUseImprovedJoinElimination
}
